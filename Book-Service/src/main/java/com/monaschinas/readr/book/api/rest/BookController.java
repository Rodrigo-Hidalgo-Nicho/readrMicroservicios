...
public class BookController {
  ...
  public Page<BookResource> getBooksBySagaId(@PathVariable Long sagaId, Pageable pageable){
    return mapper.modelListPage(bookService.getBySagaId(sagaId), pageable);
  }
